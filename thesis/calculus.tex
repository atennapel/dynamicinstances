...
\begin{align*}
	s \Coloneqq		&\; s_{var} \;|\; \change{s_{loc}} \\
	\ty \Coloneqq 		&\; \tinst{s}{\eff} \;|\; \tarr{\ty}{\cty} \;|\; \tforall{s_{var}}{\cty} \\
	\cty \Coloneqq 		&\; \aty{\ty}{r} \\
	\val \Coloneqq		&\; x, y, z, k \;|\; \change{\vinst{\loc}} \;|\; \vabs{x}{\comp} \;|\; \vabst{s_{var}}{\comp} \\
	\comp \Coloneqq	&\; \creturn{\val} \;|\; \capp{\val}{\val} \;|\; \cdo{x}{\comp}{\comp} \;|\; \cop{\val}{\op}{\val} \;|\; \cappt{\val}{s} \\
					...
					&\;|\; \change{\chandlec{s_{loc}}{\comp}}							\\
					&\;|\; \change{\chandlei{\loc}{\handler}{\comp}}						\\
...
In Figure~\ref{fig:syntax-calc} we show the syntax of the types and terms of \lang{}.
...
\inferH{T-New}{
	...
	s \in r \\
	\Delta;\Gamma,y : \ty_2 \vdash \comp' : \aty{\ty_3}{r} \\
}{
	\Delta;\Gamma \vdash \cnew{\eff}{s}{\handler; \hfinally{y}{\comp'}}{x}{\comp} : \aty{\ty_3}{r}
}
\and
\inferH{T-Handle}{
...
\inferH{T-HandleInst}{
	\Delta[\loc] = (s_{loc}, \eff) \\
	\op \in \Op{\eff} \iff \op \in \handler \\
	\Delta;\Gamma \vdash \comp : \aty{\ty_1}{r} \\
	\Delta;\Gamma \vdash^{\ty_1} \handler : \aty{\ty_2}{r} \\
	% s_{loc} \in r
}{
	\Delta;\Gamma \vdash \chandlei{\loc}{\handler}{\comp} : \aty{\ty_2}{r}
}
}
\and
\inferH{T-SubComp}{
...
\inferH{S-HandleScopeNew}{
	...
	\chandlec{s_{loc}}{\cdo{y}{\chandlei{\loc}{\handler}{\comp[x := \vinst{\loc}]}}{\comp'}}
}
\end{mathpar}
...
\inferH{S-HandleInstCong}{
	...
	\chandlei{\loc}{\handler}{\comp} \opsem{\sigma} \chandlei{\loc}{\handler}{\comp'}
}
\and
\inferH{S-HandleInstNew}{
}{
	\chandlei{\loc}{\handler}{\cnew{\eff}{s}{\handler' ; \hfinally{y}{\comp'}}{x}{\comp}} \opsem{\sigma} \\
	\cnew{\eff}{s}{\handler' ; \hfinally{y}{\comp'}}{x}{\chandlei{\loc}{\handler}{\comp}}
}
\and
\inferH{S-HandleInstOpPrepare}{
}{
	\chandlei{\loc}{\handler}{\cop{\val_1}{\op}{\val_2}} \opsem{\sigma} \\
	\chandlei{\loc}{\handler}{\cdo{x}{\cop{\val_1}{\op}{\val_2}}{\creturn{x}}}
}
\and
\inferH{S-HandleInstOpSkip}{
	\loc \neq \loc'
}{
	\chandlei{\loc}{\handler}{\cdo{x}{\cop{\vinst{\loc'}}{\op}{\val}}{\comp}} \opsem{\sigma} \\
	(\cdo{x}{\cop{\vinst{\loc'}}{\op}{\val}}{\chandlei{\loc}{\handler}{{\comp}}})
}
\and
\inferH{S-HandleInstOp}{
	\handler[\op] = (x, k, \comp_{\op})
}{
	\chandlei{\loc}{\handler}{\cdo{y}{\cop{\vinst{\loc}}{\op}{\val}}{\comp}} \opsem{\sigma} \\
	\comp_{\op}[x := \val, k := (\vabs{y}{\chandlei{\loc}{\handler}{\comp}})]
}
\and
\inferH{S-HandleInstReturn}{
}{
	\chandlei{\loc}{\handler; \hreturn{x_r}{\comp_r}}{\creturn{\val}} \opsem{\sigma}
	\comp_r[x_r := \val]
}
\end{mathpar}
