...
We now give the typing rules of our calculus.
We split them up in three figures: Figure~\ref{fig:val-typing-calc} for the values, Figure~\ref{fig:comp-typing-calc} for the computations, and Figure~\ref{fig:handler-typing-calc} for the handlers.
