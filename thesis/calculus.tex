...
\inferrule{
	...
	\chandlec{s}{\cnew{\eff}{s'}{\handler ; \hfinally{y}{\comp'}}{x}{\comp}} \;|\; \Sigma \rightsquigarrow \\
	\cnew{\eff}{s'}{\handler ; \hfinally{y}{\comp'}}{x}{\chandlec{s}{\comp}} \;|\; \Sigma
}
$$
$$
\inferrule{
	...
	\chandlec{s}{\cnew{\eff}{s}{\handler; \hfinally{y}{\comp'}}{x}{\comp}} \;|\; \Sigma \rightsquigarrow \\
	\chandlec{s}{\cdo{y}{\chandlei{\loc}{\handler}{\comp[x := \vinst{\loc}]}}{\comp'}} \;|\; \Sigma,\loc := (s, \eff)
}
$$
