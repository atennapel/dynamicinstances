...
\inferrule{
	...
	\Delta;\Sigma;\Gamma \vdash \chandlei{\loc}{\handler}{\comp} : \aty{\ty_3}{r_3}
}
$$
$$
\inferrule{
...
\inferrule{
	...
	\chandlec{s}{\cnew{\eff}{s}{\handler}{x}{\comp}} \;|\; \Sigma \rightsquigarrow
	\chandlei{\loc}{\handler}{\chandlec{s}{\comp[x := \vinst{\loc}]}} \;|\; \Sigma,\loc := (s, \eff)
}
$$
...
\inferrule{
	...
	\chandlei{\loc}{\handler}{\cdo{x}{\cop{\vinst{\loc}}{\op}{\val}}{\comp}} \;|\; \Sigma \rightsquigarrow 
	\comp_{\op}[x := \val, k := (\vabs{x}{\chandlei{\loc}{\handler}{\comp}})] \;|\; \Sigma
}
$$
$$
\inferrule{
