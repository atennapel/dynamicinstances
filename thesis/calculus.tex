...
\inferrule{
	...
	\capp{(\vabs{x}{\comp})}{\val} \;|\; n \rightsquigarrow \comp[x := \val] \;|\; n
}
\hspace{3em}
\mprset{vskip=0 ex}
\inferrule{
}{
	\cappt{(\vabst{s}{\comp})}{s'} \;|\; n \rightsquigarrow \comp[s := s'] \;|\; n
}
$$
$$
\inferrule{
	\comp_1 ; n \rightsquigarrow \comp'_1 ; n'
}{
	(\cdo{x}{\comp_1}{\comp_2}) \;|\; n \rightsquigarrow (\cdo{x}{\comp'_1}{\comp_2}) \;|\; n'
}
\hspace{3em}
\mprset{vskip=0 ex}
\inferrule{
}{
	(\cdo{x}{(\creturn{\val})}{\comp}) \;|\; n \rightsquigarrow \comp[x := \val] \;|\; n
}
$$
$$
\inferrule{
}{
	(\cdo{y}{(\cdo{x}{\comp_1}{\comp_2})}{\comp_3} \;|\; n \rightsquigarrow
	(\cdo{x}{\comp_1}{\cdo{y}{\comp_2}{\comp_3}}) \;|\; n
}
$$
$$
\inferrule{
}{
	(\cdo{x}{(\cnew{\eff}{s}{\handler}{y}{\comp_1})}{\comp_2}) \;|\; n \rightsquigarrow \cnew{\eff}{s}{\handler}{y}{(\cdo{x}{\comp_1}{\comp_2})} \;|\; n
}
$$
$$
\inferrule{
	...
	\chandle{\vabst{s}{\comp}} \;|\; n \rightsquigarrow \chandlec{s'}{\comp[s := s']} \;|\; n
}
\hspace{3em}
\mprset{vskip=0 ex}
\inferrule{
	\comp \;|\; n \rightsquigarrow \comp' \;|\; n'
}{
	\chandlec{s}{\comp} \;|\; n \rightsquigarrow \chandlec{s}{\comp'} \;|\; n'
}
$$
$$
\inferrule{
}{
	\chandlec{s}{\creturn{\val}} \;|\; n \rightsquigarrow
	\creturn{\val} \;|\; n
}
$$
$$
\inferrule{
	...
	\chandlec{s}{\cop{\val_1}{\op}{\val_2}} \;|\; n \rightsquigarrow
	\chandlec{s}{\cdo{x}{\cop{\val_1}{\op}{\val_2}}{\creturn{x}}} \;|\; n
}
$$
$$
\inferrule{
}{
	\chandlec{s}{\cdo{x}{\cop{\val_1}{\op}{\val_2}}{\comp}} \;|\; n \rightsquigarrow
	(\cdo{x}{\cop{\val_1}{\op}{\val_2}}{\chandlec{s}{\comp}}) \;|\; n
}
$$
$$
\inferrule{
	...
	\chandlec{s}{\cnew{\eff}{s'}{\handler}{x}{\comp}} \;|\; n \rightsquigarrow
	\cnew{\eff}{s'}{\handler}{x}{\chandlec{s}{\comp}} \;|\; n
}
$$
$$
\inferrule{
	...
	\chandlec{s}{\cnew{\eff}{s}{\handler}{x}{\comp}} \;|\; n \rightsquigarrow
	\chandlei{\vinst{n}}{\handler}{\chandlec{s}{\comp[x := \vinst{n}]}} \;|\; n + 1
}
$$
$$
\inferrule{
	...
	\chandlei{\vinst{n}}{\handler}{\comp} \;|\; n \rightsquigarrow \chandlei{\vinst{n}}{\handler}{\comp'} \;|\; n'
}
$$
$$
\inferrule{
