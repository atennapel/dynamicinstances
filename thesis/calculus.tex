...
}\quad(\footnotesize\textsc{S-HandleScopeCong})
$$
$$
\inferrule{
}{
	...
	\creturn{\val} \;|\; \Sigma
}\quad(\footnotesize\textsc{S-HandleScopeReturn})
$$
$$
\inferrule{
}{
...
}\quad(\footnotesize\textsc{S-HandleScopeOp})
$$
$$
\inferrule{
}{
...
}\quad(\footnotesize\textsc{S-HandleScopeSeqOp})
$$
$$
\inferrule{
	s_{loc} \neq s'_{loc}
...
}\quad(\footnotesize\textsc{S-HandleScopeNewSkip})
$$
$$
\inferrule{
...
}\quad(\footnotesize\textsc{S-HandleScopeNew})
$$
...
}\quad(\footnotesize\textsc{S-HandleInstCong})
$$
$$
\inferrule{
}{
...
}\quad(\footnotesize\textsc{S-HandleInstNew})
$$
$$
\inferrule{
}{
...
}\quad(\footnotesize\textsc{S-HandleInstOpPrepare})
$$
$$
\inferrule{
	\loc \neq \loc'
...
}\quad(\footnotesize\textsc{S-HandleInstOpSkip})
$$
$$
\inferrule{
...
}\quad(\footnotesize\textsc{S-HandleInstOp})
$$
$$
\inferrule{
}{
...
}\quad(\footnotesize\textsc{S-HandleInstReturn})
$$
