...
Extending the language with a \identp{lift} (also called \identp{inject}) operation to inject effects, skipping a handler, some notion of mutable references can be implemented~\autocite{handlewithcare}.
